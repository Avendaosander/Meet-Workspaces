...
function FormReservation({ setShowForm }) {
	...
	return (
		<article className='fixed top-0 h-screen w-full bg-black/50 z-10 flex justify-center items-center'>
			<form className='flex flex-col gap-8 px-5 bg-cyan-100 py-10 rounded-xl ring-2 ring-sky-700 w-[270px]'>
				<h2 className='text-center text-2xl font-bold'>Reservacion</h2>
				...
				<p className='text-center'>Precio o FREE</p>
				<div className='flex justify-between items-center'>
					<button className='mx-auto bg-cyan-700 text-sky-50 py-1 px-5 rounded-lg hover:animate-pulse'>
						Reservar
					</button>
					<button
						className='mx-auto bg-rose-600 text-sky-50 py-1 px-5 rounded-lg hover:animate-pulse'
						onClick={e => {
							e.preventDefault()
							setShowForm(false)
						}}
